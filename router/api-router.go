...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.PUT("/proxy_pools", controller.UpdateProxyPools)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/proxy_pools", controller.GetProxyPools)
			channelRoute.POST("/proxy_pools/probe", controller.ProbeProxyPools)
		...
		dataRoute.GET("/channels/today", middleware.AdminAuth(), controller.GetTodayChannelStats)
