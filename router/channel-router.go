...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/proxy_pools", permission: authz.ChannelRead, handler: controller.GetProxyPools},
	{method: http.MethodPost, path: "/proxy_pools/probe", permission: authz.ChannelOperate, handler: controller.ProbeProxyPools},
